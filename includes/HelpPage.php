...
class CSBHelpPage{
	...
	function adminEnqueueScripts( $hook ) {
		if( strpos( $hook, 'csb-help' ) ){
			wp_enqueue_style( 'csb-admin-help', CSB_DIR_URL . 'build/admin-help.css', [], CSB_VERSION );
			wp_enqueue_script( 'csb-admin-help', CSB_DIR_URL . 'build/admin-help.js', [ 'react', 'react-dom' ], CSB_VERSION );
