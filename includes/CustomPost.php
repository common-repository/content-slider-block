...
class CSBCustomPost{
	...
	function adminEnqueueScripts( $hook ){
		if( 'edit.php' === $hook || 'post.php' === $hook ){
			wp_enqueue_style( 'csb-admin-post', CSB_DIR_URL . 'build/admin-post.css', [], CSB_VERSION );
			wp_enqueue_script( 'csb-admin-post', CSB_DIR_URL . 'build/admin-post.js', [], CSB_VERSION );
